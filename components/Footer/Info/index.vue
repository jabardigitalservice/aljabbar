<template>
  <div class="grid grid-flow-row md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
    <div class="grid grid-cols-[24px,auto] gap-4">
      <img src="/icons/map.svg" aria-hidden="true" height="24" width="24">
    ...
    <div class="grid grid-cols-[24px,auto] gap-4">
      <img src="/icons/mail.svg" aria-hidden="true" height="24" width="24">
      <div class="flex flex-col">
    ...
    <div class="grid grid-cols-[24px,auto] gap-4">
      <img src="/icons/contact.svg" aria-hidden="true" height="24" width="24">
      <div class="flex flex-col">
    ...
    <div class="grid grid-cols-[24px,auto] gap-4">
      <img src="/icons/social.svg" aria-hidden="true" height="24" width="24">
      <div class="flex flex-col gap-3">
        ...
        <div class="flex flex-col md:flex-row gap-2 md:gap-6">
          <a class="flex" href="https://www.instagram.com/masjidrayaaljabbar/" target="_blank">
            <img src="/icons/instagram.svg" aria-hidden="true" height="24" width="24">
          ...
          <a class="flex" href="https://www.youtube.com/@masjidaljabbar/" target="_blank">
            <img src="/icons/youtube.svg" aria-hidden="true" height="24" width="24">
            <p class="text-[#424242] text-sm leading-6 font-medium ml-3">
              Youtube
            </p>
          </a>
